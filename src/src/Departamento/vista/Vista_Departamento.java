...
public class Vista_Departamento extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 310, 110, 30));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 310, 100, 30));

        tabla_departamento.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        ...
        tabla_departamento.setFocusable(false);
        tabla_departamento.setRequestFocusEnabled(false);
        tabla_departamento.setShowVerticalLines(true);
        ...
        jPanel1.add(btn_modificar, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 310, 90, 30));
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 270, 110, 30));
    ...
    private void btn_modificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_modificarActionPerformed
        if (!txt_codigo.getText().isEmpty()) {
            cd.modificarDepartamento(crearObjeto());
            limpiar_txt();
            tabla_departamento.setModel(cd.tabla_departamento());
        }
    }//GEN-LAST:event_btn_modificarActionPerformed

    private void evt(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_evt
        int col = tabla_departamento.getSelectedRow();
        txt_codigo.setText(tabla_departamento.getModel().getValueAt(col, 0).toString());
        txt_nombre.setText(tabla_departamento.getModel().getValueAt(col, 1).toString());
        txt_presupuesto.setText(tabla_departamento.getModel().getValueAt(col, 2).toString());
        txt_gastos.setText(tabla_departamento.getModel().getValueAt(col, 3).toString());
    }//GEN-LAST:event_evt
